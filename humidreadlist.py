...
def overwritesite(): # overwrite site content corrosponding to parsereadlist() not vpnstate()
    ...
    d['linen56'] = f'<meta property=\"og:image\" content=\"https://github.com/crbyxwpzfl/spinala/raw/main/locs/d.get("vpnto", "off")}/trans-og.png\"/> <!-- imessage wont execute js so these musst be set via github push -->\n'
